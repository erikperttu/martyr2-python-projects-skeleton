...
A repo for the project from [Martyr2’s Mega Project List](http://www.dreamincode.net/forums/topic/78802-martyr2s-mega-project-ideas-list/), done with Python in mind. 

No code just empty files and directories. Some of these bigger projects should probably have more than one file and their own folder, but this is just to get you started.

README.md painstakingly copied and pasted from [thekarangoel](https://github.com/thekarangoel/Projects)
...
**Unit Converter (temp, currency, volume, mass and more)** – Converts various units between one another. The user enters the type of unit being enterd, the type of unit they want to convert to and then the value. The program will then make the conversion.
